...
UnPlug2SearchPage = {
	UnPlug2SearchPage : function (serialized_pages) {
		/*
		serialized_pages is the list generated by content/webpagecontext/gethtml.js
		*/
		this.serialized_pages = serialized_pages;
		this.main_url = serialized_pages[0].url;
	...
	do_search : function () {
		try {
			...
			UnPlug2Search.search(this.serialized_pages, this._search_callback)
		} catch (e) {
			UnPlug2.log("search error " + e.toSource());
		}
	},
	...
	send_nothing_found_msg_noask : function () {
		...
		var dl = new UnPlug2Download(
				...
				"problem=yes&useragent=" +  escape(window.navigator.userAgent) + "&url="  + escape(UnPlug2SearchPage.main_url) + "&version=" + UnPlug2.version + "&revision=" + UnPlug2.revision + "&codename=" + UnPlug2.codename,
				null, null, // callbacks
				10000);
		dl.start()
	},
